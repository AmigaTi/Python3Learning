...
async def hello(num):             # 把一个generator标记为coroutine类型
...
'''
Hello world! (2, <_MainThread(MainThread, started 26188)>)
Hello world! (1, <_MainThread(MainThread, started 26188)>)
Hello world! (3, <_MainThread(MainThread, started 26188)>)
Hello again! (2, <_MainThread(MainThread, started 26188)>)
Hello again! (1, <_MainThread(MainThread, started 26188)>)
Hello again! (3, <_MainThread(MainThread, started 26188)>)
'''